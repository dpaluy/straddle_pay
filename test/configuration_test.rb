...
class ConfigurationTest < Minitest::Test
  ...
  def test_configure_block
    StraddlePay.configure do |config|
      ...
      config.base_url = "https://production.straddle.com"
  ...
  def test_sandbox_and_production_urls
    assert_equal "https://sandbox.straddle.com", StraddlePay::Config::SANDBOX_URL
    assert_equal "https://production.straddle.com", StraddlePay::Config::PRODUCTION_URL
  end
end
